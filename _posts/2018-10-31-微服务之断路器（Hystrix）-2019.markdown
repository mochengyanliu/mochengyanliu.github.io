...
右键工程->创建model->选择web->web,cloud discovery->eureka discovery,cloud routing->ribbon,cloud circuit breaker->hystrix,然后一直下一步就行了。
...
#### 配置appication.yml文件,Feign是自带断路器的，它没有默认打开。需要在配置文件中配置打开它，在配置文件加以下代码：
...
[https://github.com/mochengyanliu/SpringCloudLearn/tree/master/section3](https://github.com/mochengyanliu/SpringCloudLearn/tree/master/section4)
